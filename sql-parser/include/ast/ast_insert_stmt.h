...
public:
    ...
    public:
        explicit InsertStmtValList(insert_opts insert_opts, const char *name, Ast_OptColNames *opt_col_names,
    ...
    public:
        explicit InsertStmtAsgnList(insert_opts insert_opts, const char *name, 
    ...
    public:
        explicit InsertStmtSelect(insert_opts insert_opts, const char *name, Ast_OptColNames *opt_col_names,
...
public:
    explicit Ast_InsertStmt(insert_opts insert_opts, const char *name, Ast_OptColNames *opt_col_names,
        Ast_InsertValList *insert_val_list, Ast_OptOnDupUpdate *opt_dupupdate);
    explicit Ast_InsertStmt(insert_opts insert_opts, const char *name, Ast_InsertAsgnList *insert_asgn_list,
        Ast_OptOnDupUpdate *opt_ondupupdate);
    explicit Ast_InsertStmt(insert_opts insert_opts, const char *name, Ast_OptColNames *opt_col_names,
        Ast_SelectStmt *select_stmt, Ast_OptOnDupUpdate *opt_ondupupdate);
