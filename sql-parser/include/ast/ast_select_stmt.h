...
public:
    enum select_opts {
        SELECT_OPTS_ALL                 = 1,
        SELECT_OPTS_DISTINCT            = 2,
        SELECT_OPTS_DISTINCTROW         = 3,
        SELECT_OPTS_HIGH_PRIORITY       = 4,
        SELECT_OPTS_STRAIGHT_JOIN       = 5,
        SELECT_OPTS_SQL_SMALL_RESULT    = 6,
        SELECT_OPTS_SQL_BIG_RESULT      = 7,
        SELECT_OPTS_SQL_CALC_FOUND_ROWS = 8
    };
    enum select_type {
